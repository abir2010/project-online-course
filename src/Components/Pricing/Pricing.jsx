            ...
            <div class="p-8 bg-gray-900 rounded">
              ...
              <ul class="mb-8 space-y-2">
                <li class="flex items-center">
                  ...
                  <p class="font-medium text-gray-300">10 lessons per day</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
                ...
                <li class="flex items-center">
                  ...
                  <p class="font-medium text-gray-300">3 quizes</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
                  ...
                  <p class="font-medium text-gray-300">Daily task</p>
                </li>
              </ul>
              <Button />
            </div>
          ...
          <div>
            <div class="p-8 bg-gray-900 rounded">
              <div class="mb-4 text-center">
                ...
                <div class="flex items-center justify-center">
                  <p class="mr-2 text-5xl font-semibold text-indigo-400 lg:text-6xl">
                    $59
                  </p>
                  <p class="text-lg text-gray-500">/ month</p>
                </div>
              ...
              <ul class="mb-8 space-y-2">
                <li class="flex items-center">
                  ...
                  <p class="font-medium text-gray-300">50 lessons per day</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
                ...
                <li class="flex items-center">
                  ...
                  <p class="font-medium text-gray-300">Unlimited quizes</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
